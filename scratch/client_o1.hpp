...
private:
  ...
  std::string _energySavingState = "";
  std::string _energySavingStateNs3 = "";
...
public:
  std::string set_from_xml(pugi::xml_node entry) {
    ...
    if (entry.child("energySavingState")) {
      try {
        _energySavingState =
            entry.child("energySavingState").text().as_string();
    ...
    if (entry.child("energySavingStateNs3")) {
      try {
        _energySavingStateNs3 =
            entry.child("energySavingStateNs3").text().as_string();
  ...
  std::string energySavingState() {
    if (!defined["energySavingState"])
      std::cout << " energySavingState error " << std::endl;
    return _energySavingState;
  }
  std::string energySavingStateNs3() {
    if (!defined["energySavingStateNs3"])
      std::cout << " energySavingStateNs3 error " << std::endl;
    return _energySavingStateNs3;
  }
